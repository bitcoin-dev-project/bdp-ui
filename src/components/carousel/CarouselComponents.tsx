...
export const CarouselItem: React.FC<CarouselItemProps> = ({
  ...
  return (
    <div
      className={twMerge(clsx("flex-shrink-0 relative", className))}
      {...rest}
    >
      {children}
    </div>
...
export const CarouselControls: React.FC<CarouselControlProps> = ({
  ...
  return (
    <div
      className={twMerge(
        clsx("flex items-center gap-2 md:gap-4 w-fit mx-auto pt-4", className),
      )}
      {...props}
    >
      {children}
...
export const CarouselPreviousButton: React.FC<CarouselButtonProps> = ({
  children,
  ...props
}) => {
...
export const CarouselNextButton: React.FC<CarouselButtonProps> = ({
  children,
  ...props
}) => {
