...
interface CarouselContainerProps
  extends ComponentStylePrimitiveProps<HTMLDivElement> {
...
interface CarouselButtonProps
  extends Omit<ComponentStylePrimitiveProps<HTMLButtonElement>, "children"> {
  children?:
...
declare const Carousel: React__default.FC<
  Omit<CarouselProviderProps, "containerRef">
> & {
...
type SelectContextType$1 = {
  containerRef: React__default.MutableRefObject<HTMLDivElement> | null;
  setContainerRef: React__default.Dispatch<
    React__default.SetStateAction<React__default.MutableRefObject<HTMLDivElement> | null>
  >;
  searchInputRef: React__default.MutableRefObject<HTMLInputElement> | null;
  setSearchInputRef: React__default.Dispatch<
    React__default.SetStateAction<React__default.MutableRefObject<HTMLInputElement> | null>
  >;
  isListOpen: boolean;
  toggleListOpen: () => void;
  currentNavigateCheckbox: string;
...
declare const MultiSelectProvider: ({
  children,
  isCollapsible,
}: SelectProviderProps) => React__default.JSX.Element;
...
type SingleSelectListProps = Omit<
  SelectListProps,
...
declare const SingleSelect: React__default.FC<
...
export {
  ...
  MultiSelect,
  MultiSelectProvider,
  type SelectContextType$1 as SelectContextType,
  Separator,
  SingleSelect,
  useMultiSelect,
  useSingleSelect,
