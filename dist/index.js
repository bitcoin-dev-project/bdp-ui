    ...
    import_react6.default.Children.forEach(children, (child, index) => {
      if (import_react6.default.isValidElement(child)) {
        ...
        if (index < import_react6.default.Children.count(children) - 1) {
          newChildren.push(import_react6.default.cloneElement(viewSeparator, { key: `${displayName}-separator-${index}` }));
        }
      }
    });
    return newChildren;
...
var CarouselProvider = ({ children, containerRef, config = DefaultCarouselConfig }) => {
  ...
  return /* @__PURE__ */ import_react8.default.createElement(CarouselContext.Provider, { value: { containerRef, totalCarouselItems, goToNextSlide, goToPreviousSlide, possibleDirection } }, children);
};
