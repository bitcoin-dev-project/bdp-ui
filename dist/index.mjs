...
var Platform = ({ platform }) => {
  ...
  const getIcon = (entity2) => {
    ...
    if (entity2 === "twitter") {
      return /* @__PURE__ */ React33.createElement(TwitterXIcon_default, {
        className: twMerge3(clsx3("w-full", className)),
        ...rest,
      });
    }
    if (entity2 === "github") {
      return /* @__PURE__ */ React33.createElement(GithubIcon_default, {
        className: twMerge3(clsx3("w-full", className)),
        ...rest,
      });
    }
    if (entity2 === "discord") {
      return /* @__PURE__ */ React33.createElement(DiscordIcon_default, {
        className: twMerge3(clsx3("w-full", className)),
        ...rest,
      });
    }
    if (entity2 === "nostr") {
      return /* @__PURE__ */ React33.createElement(NostrIcon_default, {
        className: twMerge3(clsx3("w-full", className)),
        ...rest,
      });
    }
    if (entity2 === "linkedin") {
      return /* @__PURE__ */ React33.createElement(LinkedinIcon_default, {
        className: twMerge3(clsx3("w-full", className)),
        ...rest,
      });
    }
...
var FooterSocials = (props) => {
  ...
  return /* @__PURE__ */ React33.createElement(
    ...
    platforms.map((platform) =>
      /* @__PURE__ */ React33.createElement(Platform, {
        key: platform.entity,
        platform,
      }),
    ),
...
var Footer = ({ children, className, separator, ...rest }) => {
  const viewSeparator =
    separator != null
      ? separator
      : /* @__PURE__ */ React35.createElement(Separator, null);
...
var SelectInput = ({ defaultPlaceholder, className, styles = {} }) => {
  ...
  return /* @__PURE__ */ React38.createElement(
    ...
    /* @__PURE__ */ React38.createElement(
      ...
      /* @__PURE__ */ React38.createElement(SearchIcon_default, {
    ...
    /* @__PURE__ */ React38.createElement(
      ...
      /* @__PURE__ */ React38.createElement(ArrowRight_default, {
...
var SelectList = (props) => {
  ...
  return /* @__PURE__ */ React40.createElement(BaseSelectList_default, {
    ...props,
...
var SingleSelectList = (props) => {
  ...
  return /* @__PURE__ */ React42.createElement(BaseSelectList_default, {
    ...props,
...
var SingleSelectTrigger = ({ defaultPlaceholder, className, styles = {} }) => {
  ...
  return /* @__PURE__ */ React43.createElement(
    ...
    /* @__PURE__ */ React43.createElement(
      ...
      /* @__PURE__ */ React43.createElement(ArrowRight_default, {
